...
class PatientPriorAuthRequest(BaseModel):
    ...
    icd_10_pcs_codes: List[str] = Field(default_factory=list, description="Requested ICD-10-PCS procedure codes.")
    modifiers: List[str] = Field(default_factory=list, description="CPT/HCPCS modifiers (e.g., RT, LT, KX).")
    revenue_codes: List[str] = Field(default_factory=list, description="Associated revenue or bill codes.")
...
class ClinicalEvidencePacket(BaseModel):
    ...
    icd_10_pcs_codes: List[str] = Field(default_factory=list, description="Requested ICD-10-PCS procedure codes.")
    modifiers: List[str] = Field(default_factory=list, description="Requested CPT/HCPCS modifiers (e.g., RT, LT, KX).")
    revenue_codes: List[str] = Field(default_factory=list, description="Requested revenue or bill codes.")
